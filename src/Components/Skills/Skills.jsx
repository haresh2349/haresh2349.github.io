...
import { GitCalendar } from '../GithubCalender/GitCalendar'
  ...
  return (
    ...
    >
      <div className="container skills">
        <Flip right>
          <div className="s-heading s-main_heading">
            <p>My Skills</p>
          </div>
            ...
            <div className="s">
              <Bounce left>
                <div className="s-box">
                  <div className="s-img-box">
                    <img
                      src="	https://www.goodday.work/site/assets/img/solutions/team-collaboration/header-team-collaboration@2x.png"
                      alt=""
                    />
                  </div>
                  <p className="s-name">Team Collaboration</p>
                </div>
              </Bounce>
              <Bounce left>
                <div className="s-box">
